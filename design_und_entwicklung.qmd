...
Weitere Erkenntnis: \
Bei der Evaluation ist aufgefallen, dass speziell in diesem fall die lange Anfrage mit besonderen Detailfragen wie die Dicke der Arbeitsplatte und das Material 
in das die Steckdosen gebohrt werden sollen dem Chatbot zu schaffen machte. Die Zeit die Frage zu beantoworten lag bei ca. 1 Minute und länger.
Weitergehend konnte der Chatbot auf kurze Rückfragen aber schnell reagieren. Speziell bei solchen Komplexen Fragen zu mehreren Produkten tut sich der Bot schwer und ist für diesen Fall nicht so gut geeignet wie für kurze Fragen zu einzelnen Produkten. 
...
**Testszenario 4:** ***Ein Akkuschrauber mit Bums!***
**Frage an den Assistant Bot:**
Ich möchte einen Akkuschrauber mit bums
**Optimal Antwort:*** \
- Als Akku-Schrauber eignet sich am besten der **Akku-Bohrschrauber  TID 18**

**Testrunden:** \
Runde 1: \ 
- Produkt falsch, aber Link funktioniert → 1P
Runde 2: \ 
- Richtige Antwort, aber Link funktioniert  → 2P
Runde 3: \ 
- Produkt falsch, aber Link funktioniert → 1P
Runde 4: \ 
- Passendes Produkt und Link funktioniert → 3P
Runde 5: \ 
- Richtige Antwort, aber kein Link → 2P
Runde 6: \ 
- Passendes Produkt und Link funktioniert → 3P
Runde 7: \ 
- Passendes Produkt und Link funktioniert → 3P
...
**Auswertung:**
Von 30 möglichen Punkten im Szenario 4, hat der Chatbot **21 Punkte** erreicht. Das Entpricht einer Genauigkeit von **70%**
Die Richtigkeit bei den Antworten liegt bei 70 %.
 Die Antworten des Bots sind stellenweisen sehr inkonsistent, da ab und zu alles richtig beantwortet wird. Jedoch häufig, eine dieser Komponenten: Link, richtiges Produkt oder Rückfrage vernachlässigt, werden. Des Weiteren ist die Antwortzeit, auch bei einer so kurzen Frage, sehr lange. Positiv ist die Wortwahl, da diese vertrauen vermittelt.
